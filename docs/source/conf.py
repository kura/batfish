...
latex_documents = [
  ('index', 'batfish.tex', u'Batfish Documentation',
   u'Kura', 'manual'),
]
...
man_pages = [
    ('index', 'Batfish', u'Batfish Documentation',
     [u'Kura'], 1)
]
...
texinfo_documents = [
  ('index', 'Batfish', u'Batfish Documentation',
   u'Kura', 'Batfish', 'One line description of project.',
   'Miscellaneous'),
]
